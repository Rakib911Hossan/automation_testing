...
export class ClientPage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.clientConnectivityTypeDropdown = page.locator('div').filter({ hasText: /^Share\*Select \.\.\.$/ }).locator('span').nth(4);
    ...
    async addClient(data: {
        ...
        await this.clientConnectivityTypeDropdown.click();
          await this.page.locator('div').filter({ hasText: /^Share$/ }).click();
